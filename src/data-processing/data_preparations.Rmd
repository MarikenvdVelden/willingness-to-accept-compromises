...
d %>%
  ...
  labs(x = "", y = "Strongly disagree (1) - Strongly agree (5)", title = "Most politicians are trustworthy") +
  theme_minimal() +
...
d %>%
  ...
  geom_col(alpha = .2, fill = "seagreen") +
  geom_errorbar(position = position_dodge(width=0.9), width = 0.2, colour = "darkgrey") +
  labs(x = "", y = "Strongly Disagree (1) - Strongly agree (5)", title = "Compromise is selling out principles") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
