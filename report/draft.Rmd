...
```{r results-h3, out.width = "100%", fig.align = 'center', fig.cap = "\\label{fig:results-h3}Results: H3"}
include_graphics(here("report/figures", "h3-1.png"))
```

```{r results-h3p, out.width = "100%", fig.align = 'center', fig.cap = "\\label{fig:results-h3p}Results: H3 pooled"}
include_graphics(here("report/figures", "h3-2.png"))
```
